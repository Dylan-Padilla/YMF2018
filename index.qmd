...
for(i in 1:n_pops){
  ...
  text(i, t_div*0.05+10, labels = rep(expression(italic(N[e])), 5), 
       cex = 0.6, font = 2, col = "chocolate4")
}
...
polygon(c(trunk_center - aw, trunk_center + aw, trunk_center + aw, trunk_center - aw),
        ...
        col = "tan", border = "chocolate4")
NANC <- "4024"
text(trunk_center, t_div+30, NANC, font = 2, cex = 0.6, col = "chocolate4")
text(trunk_center, t_div+40, expression(italic("N"[e])), font = 2, cex = 0.6,
                                        col = "chocolate4")
